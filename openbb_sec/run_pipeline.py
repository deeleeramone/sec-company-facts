"""One-shot pipeline runner for the SEC DuckDB store.
...
Usage:
    python -m openbb_sec.run_pipeline \\
...
from openbb_sec.db.ingest import (
...
def _derived_counts(db_path: str | None = None) -> tuple[int, int]:
    from openbb_sec.db.ingest import _connect, _finalize, _table  # pylint: disable=import-outside-toplevel
