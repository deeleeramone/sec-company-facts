...
def companies():
    ...
    from openbb_sec.db.query import list_company_choices
...
def top_companies(
    ...
    from openbb_sec.db.query import top_companies_by_ratio, top_companies_by_metric, top_companies_by_sum
